...
int main()
{
    ...
    // -------------------------
    Shader shader("../shader_src/5.1.framebuffers.vs", "../shader_src/5.1.framebuffers.fs");
    Shader screenShader("../shader_src/5.1.framebuffers_screen.vs", "../shader_src/5.1.framebuffers_screen.fs");
